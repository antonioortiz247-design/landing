    ...
    <main>
      <AnimatedSection id="hero" className="section-shell flex min-h-screen items-center">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-zinc-500">Presentación de Estructura Web</p>
      ...
      <footer className="border-t border-zinc-200">
        <div className="section-shell flex flex-col items-start justify-between gap-8 py-10 md:flex-row md:items-center">
          <div>
            <p className="text-lg font-semibold tracking-tight">Estructura de Cierre</p>
            <p className="mt-1 text-sm text-zinc-500">© {new Date().getFullYear()} Resumen de navegación y enlaces.</p>
          </div>
          <nav aria-label="Enlaces finales" className="flex flex-wrap items-center gap-6 text-sm text-zinc-600">
          ...
          <div className="flex items-center gap-3 text-zinc-600">
            <Link href="#" aria-label="Enlace Social 1" className="rounded-full p-2 hover:bg-zinc-100 hover:text-zinc-900">
              <Twitter className="h-4 w-4" aria-hidden="true" />
            </Link>
            <Link href="#" aria-label="Enlace Social 2" className="rounded-full p-2 hover:bg-zinc-100 hover:text-zinc-900">
              <Linkedin className="h-4 w-4" aria-hidden="true" />
            </Link>
            <Link href="#" aria-label="Enlace Social 3" className="rounded-full p-2 hover:bg-zinc-100 hover:text-zinc-900">
